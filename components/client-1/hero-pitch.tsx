        ...
        <div className="max-w-4xl mx-auto md:mx-0">
          <div className="flex flex-col md:flex-row items-start gap-4 mb-8">
            ...
            <div className="md:ml-4">
              <h2 className="text-sm uppercase tracking-widest text-[#888] mb-2">{t("client1.aiSolutionProposal")}</h2>
              <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-8">
                {t("client1.modernBooking")} <br />
                <span className="text-[#888]">{t("client1.bookingFor")}</span> <br />
                {t("client1.forYourBarbershop")}
              </h1>
            </div>
          </div>
          ...
          <div className="mt-12 md:mt-20 md:ml-24">
            <p className="text-xl md:text-2xl text-[#aaa] max-w-xl leading-relaxed">
              {t("client1.transformDescription")}
            </p>
            ...
            <div className="mt-12 flex flex-col md:flex-row gap-6">
              ...
              >
                {t("client1.exploreSolution")}
                <svg className="ml-2 w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </a>
              <a href="#demo" className="px-8 py-4 border border-[#222] hover:border-[#444] transition-colors">
                {t("client1.seeInAction")}
              </a>
            </div>
          </div>
        </div>
